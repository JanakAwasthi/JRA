...
class ProtectedTextApp {
    ...
    // Enhanced scrolling and UI features
    ...
    initializeWindowDocking() {
        // Add window docking capabilities for multi-window editing
        this.windowPositions = {};
        this.isDocking = false;
        
        // Enhanced window management for better UX
        this.setupWindowDragAndDrop();
    }
    ...
    startWindowDrag(e, windowElement) {
        e.preventDefault();
        ...
        const dragMouseMove = (e) => {
            ...
            const newTop = Math.max(0, windowElement.offsetTop - pos2);
            const newLeft = Math.max(0, windowElement.offsetLeft - pos1);
